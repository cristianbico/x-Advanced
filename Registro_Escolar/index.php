        ...
        <div class="row">
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="nombre" name="nombre" required style="box-shadow: 5px 7px 5px rgba(0, 0, 0, 0.3);">
              <div class="invalid-feedback">Este campo es obligatorio</div>
            </div>
            <div class="mb-3">
              <label for="apellidos" class="form-label">Apellidos</label>
              <input type="text" class="form-control" name="apellidos" required style="box-shadow: 5px 7px 5px rgba(0, 0, 0, 0.3);">
              <div class="invalid-feedback">Este campo es obligatorio</div>
            </div>
            <div class="mb-3">
              <label for="curso" class="form-label">Curso</label>
              <input type="text" class="form-control" name="curso" required style="box-shadow: 5px 7px 5px rgba(0, 0, 0, 0.3);">
              <div class="invalid-feedback">Este campo es obligatorio</div>
            </div>
            <div class="mb-3">
              <label for="edad" class="form-label">Edad</label>
              <input type="number" class="form-control" id="edad" name="edad" required style="box-shadow: 5px 7px 5px rgba(0, 0, 0, 0.3);">
              <div class="invalid-feedback">Este campo es obligatorio</div>
            </div>
            <div class="mb-3">
              <label for="domicilio" class="form-label">Domicilio</label>
              <input type="text" class="form-control" id="domicilio" name="domicilio" required style="box-shadow: 5px 7px 5px rgba(0, 0, 0, 0.3);">
              <div class="invalid-feedback">Este campo es obligatorio</div>
            </div>
            <div class="mb-3">
              <label for="traslado-foto" class="form-label">Traslado Foto</label>
              <input type="file" class="form-control" id="traslado-foto" name="traslado_foto" required style="box-shadow: 5px 7px 5px rgba(0, 0, 0, 0.3);">
              <div class="invalid-feedback">Este campo es obligatorio</div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="contacto-personal" name="contacto_personal" style="box-shadow: 5px 7px 5px rgba(0, 0, 0, 0.3);">
            </div>
            <div class="mb-3">
              <label for="contacto-tutor" class="form-label">Contacto de un Familiar o Tutor</label>
              <input type="text" class="form-control" id="contacto-tutor" name="contacto_tutor" required style="box-shadow: 5px 7px 5px rgba(0, 0, 0, 0.3);">
              <div class="invalid-feedback">Este campo es obligatorio</div>
            </div>
            <div class="mb-3">
              <label for="foto-carnet" class="form-label">Foto Carnet</label>
              <input type="file" class="form-control" id="foto-carnet" name="foto_carnet" required style="box-shadow: 5px 7px 5px rgba(0, 0, 0, 0.3);">
              <div class="invalid-feedback">Este campo es obligatorio</div>
            </div>
            <div class="mb-3">
              <label for="partida-bautismo" class="form-label">Partida de Bautismo</label>
              <input type="file" class="form-control" id="partida-bautismo" name="partida_bautismo" required style="box-shadow: 5px 7px 5px rgba(0, 0, 0, 0.3);">
              <div class="invalid-feedback">Este campo es obligatorio</div>
            </div>
            <div class="mb-3">
              <label for="nombre-usuario" class="form-label">Nombre de Usuario</label>
              <input type="text" class="form-control" id="nombre-usuario" name="nombre_usuario" required style="box-shadow: 5px 7px 5px rgba(0, 0, 0, 0.3);">
              <div class="invalid-feedback">Este campo es obligatorio</div>
            </div>
            <div class="mb-3">
              <label for="contrasena" class="form-label">Contraseña</label>
              <input type="password" class="form-control" id="contrasena" name="contrasena" required style="box-shadow: 5px 7px 5px rgba(0, 0, 0, 0.3);">
              <div class="invalid-feedback">Este campo es obligatorio</div>
            </div>
            <div class="mb-3">
              <label for="correo" class="form-label">Correo</label>
              <input type="email" class="form-control" id="correo" name="correo" style="box-shadow: 5px 7px 5px rgba(0, 0, 0, 0.3);">
            </div>
          </div>
        </div>
