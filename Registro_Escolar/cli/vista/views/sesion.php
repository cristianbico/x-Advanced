        ...
        <div class="login-form">
          ...
          <form method="POST" action="../../controlador/c_usuario.php">
            <div class="form-group">
              <label for="usuario" style="color: yellow;">Usuario</label>
              <div class="input-group">
                <input type="text" class="form-control shadow-sm" name="correo" id="usuario" placeholder="Ingresa tu usuario" required>
